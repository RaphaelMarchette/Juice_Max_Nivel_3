...
<table id="table_pagar_sucos">
    <thead>
        ...
        <tr>
            ...
            <th class='botao'>
                <a href='Tools/Tools_Add_pagar.php?table=frutas&id=$user_data[id_fk]&table_2=create_juice&id_2=1' title='Adicionar' id='btn-primary'>
