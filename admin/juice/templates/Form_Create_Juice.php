...
<head>
    ...
    <link rel="stylesheet" href="../../Static_6/css/Tela.css"/>
    <link rel="stylesheet" href="../../Static_6/css/Table.css"/>
    <link rel="stylesheet" href="../../Static_6/css/Form_Create_Juice.css" />
...
<div class="box">
    <form action="new_juice.php" method="POST">
        <fieldset>
            ...
            <br><br><br>
            <div class="inputBox">
                <input type="text" name="batido" id="batido" class="inputUser_2" required disabled=true>
                <label for="batido" class="travado">Batido</label>
            </div>
            <br><br><br>
