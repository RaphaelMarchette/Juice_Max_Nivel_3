<?php
    ...
    $sql = "SELECT * FROM batido_ativo WHERE id=1";
...
<div class="title_table" id="table_batido_ativo">Liquido Batido</div>
...
<table class="table" id="table_batido_ativo">
    <thead>
            ...
            <th class="botao"   >  
                <a class='bt_table_batido' href='Go_Table_Batidos.php' title='Editar' id='btn-primary'>
    ...
    <tbody>
        <?php
            while($user_data = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<td class='botao'>
                            <a href='tools/Tools_Batido_Delete.php?table=batido_ativo&id=$user_data[id]' title='Deletar' id='btn-danger'>
